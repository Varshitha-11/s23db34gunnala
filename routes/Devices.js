...
router.get('/create', secured, Device_controlers.Device_create_Page);
/* GET create update page */
router.get('/update', secured,Device_controlers.Device_update_Page);
/* GET delete Devicespage */
router.get('/delete', secured,Device_controlers.Device_delete_Page);
